...
image:https://github.com/RemedyIT/axcioma/workflows/windows/badge.svg[Windows CI, link=https://github.com/RemedyIT/axcioma/actions?query=workflow%3Awindows]
...
To obtain and build a formal release either checkout a formal release tag after cloning this repository or download and install a formal release source package of this repository.
